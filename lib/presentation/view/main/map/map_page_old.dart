...
//   bool isCameraSwapped = false; // Camera full screen mode
//   bool isMissionPlanningMode = false; // Mission planning mode
...
//       if (boundingBoxStart == null) {
//         // First click - set start point
//         setState(() {
//           boundingBoxStart = latLng;
//         });
//       } else {
//         // Second click - set end point and show config dialog
//         setState(() {
//           boundingBoxEnd = latLng;
//         });
//         _showSurveyConfigDialog();
//       }
//       return;
//     }
...
//   void _onPointerHover(LatLng latLng) {
//     if (isDrawingBoundingBox && boundingBoxStart != null) {
//       setState(() {
//         boundingBoxEnd = latLng;
//       });
//     }
...
//     // Cancel bounding box drawing if active
//     if (isDrawingBoundingBox) {
//       _cancelBoundingBoxDrawing();
//     }
...
//   void _handleBoundingBoxSurvey() {
//     setState(() {
//       isDrawingBoundingBox = true;
...
//       selectedWaypointIds.clear();
//     });
//     _showInfo('Nhấp 2 lần trên bản đồ để vẽ vùng survey (góc đối diện)');
//   }

//   void _showSurveyConfigDialog() {
//     if (boundingBoxStart == null || boundingBoxEnd == null) return;

//     showDialog(
//       context: context,
//       builder: (context) => SurveyConfigDialog(
//         topLeft: boundingBoxStart!,
//         bottomRight: boundingBoxEnd!,
//         onConfirm: (config) {
//           _generateBoundingBoxSurvey(config);
//         },
//       ),
//     );
//   }

//   void _generateBoundingBoxSurvey(SurveyConfig config) {
//     if (boundingBoxStart == null || boundingBoxEnd == null) return;

//     // Generate waypoints using the survey generator
...
//   void _cancelBoundingBoxDrawing() {
//     setState(() {
//       isDrawingBoundingBox = false;
//       boundingBoxStart = null;
//       boundingBoxEnd = null;
...
//       case 'mission':
//         setState(() {
//           showMissionSidebar = !showMissionSidebar;
//         });
//         break;
//       case 'mission_planning':
//         setState(() {
//           isMissionPlanningMode = !isMissionPlanningMode;
//           showMissionSidebar = isMissionPlanningMode;
//         });
//         break;
//       case 'pdf':
//         setState(() {
//           showPdfCompass = !showPdfCompass;
//         });
//         break;
//     }
//   }
...
//                       children: [
//                         // Bounding box survey button (new feature)
//                         if (!isDrawingBoundingBox)
//                           Container(
//                             margin: const EdgeInsets.only(bottom: 12),
//                             child: FloatingActionButton.extended(
//                               onPressed: _handleBoundingBoxSurvey,
...
//                         // Cancel bounding box button
//                         if (isDrawingBoundingBox)
//                           Container(
//                             margin: const EdgeInsets.only(bottom: 12),
//                             child: FloatingActionButton.extended(
//                               onPressed: _cancelBoundingBoxDrawing,
//                               backgroundColor: Colors.red,
...
//                   Positioned(
//                     top: 16,
//                     right: showMissionSidebar ? null : 16,
//                     left: showMissionSidebar ? 16 : null,
//                     width: 320,
...
//                     onClose: () => setState(() => showCameraView = false),
//                     isSwapped: isCameraSwapped,
//                     onSwap: _toggleCameraSwap,
//                     mapWidget: _buildCurrentMap(),
//                   ),

//                 if (!isMissionPlanningMode && showPdfCompass)
//                   Positioned(
//                     bottom: 16,
//                     right: 16,
//                     child: Container(
...
//                             satellites: (telemetry['satellites'] ?? 0.0)
//                                 .toInt(),
//                           );
//                         },
//                       ),
...
//           // Mission Control Sidebar (30% width when visible)
//           if (showMissionSidebar)
//             Expanded(
//               flex: 3,
//               child: Container(
//                 decoration: BoxDecoration(
...
//                     // Elegant collapse button at top-left corner
//                     Positioned(
//                       right: 0,
//                       top: 0,
//                       child: Material(
...
//                           ),
//                           onTap: () =>
//                               setState(() => showMissionSidebar = false),
//                           child: Container(
//                             decoration: BoxDecoration(
//                               borderRadius: const BorderRadius.only(
//                                 bottomRight: Radius.circular(16),
